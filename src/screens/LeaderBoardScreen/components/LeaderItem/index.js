...
const LeaderItem = ({ leader }) => {
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
      ...
      <Image style={{ width: 32, height: 32, marginHorizontal: 10 }} source={{ uri: leader.ImageUrl }} />
      <View>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ fontFamily: fontFamily.gothamLight, fontSize: fontSize.small }}>{leader.Achievements}</Text>
        </View>
      </View>
    </View>
  )
