...
import { Modal, SectionList, Text, TouchableOpacity, View, AsyncStorage, Alert } from 'react-native'
              ...
              {languages
                ...
                .map((item, i) => (
                  <View
                    ...
                    style={{
                      backgroundColor:
                        item.code.toLowerCase() == i18n.locale.toLowerCase() ? colorConstants.themeColor : 'transparent'
                    }}
                  >
                    <TouchableOpacity
                      onPress={() => {
      ...
      >
        ...
        >
          ...
          <Text
            style={{
              ...styles.sectionText,
              marginLeft: i18n.locale.toLowerCase() == 'en' ? (item.icon ? 10 : 0) : 10,
              marginRight: i18n.locale.toLowerCase() == 'en' ? 10 : item.icon ? 10 : 0
            }}
          >
            {item.text()}
          </Text>
        </View>
        <Icon name={i18n.locale.toLowerCase() == 'en' ? 'angle-right' : 'angle-left'} color="#6D6E71" size={22} />
      </TouchableOpacity>
    )
  }
        ...
        {!isAuthorized && (
          <View style={styles.loginContainer}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('SignUp')} style={styles.greenButtonRegister}>
