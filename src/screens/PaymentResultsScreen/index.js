  ...
  getConfig = (isSuccess, amountToPay) => {
    return {
      ...
      paymentStatus: isSuccess
        ? i18n.t('events.payment_is_succesful')
        : i18n.t('events.payment_failed'),
      bodyText: isSuccess
        ? i18n.t('events.your_payment_of_aed_was_successfully_completed')
        : i18n.t(
            'events.your_payment_was_not_proceed_succesfully_your_credit_card_was_not_charged_please_try_again'
          ),
