    ...
    <G data-name="camera icon" transform="translate(-137 -227)">
      ...
      <G data-name={35422}>
        <G data-name="Group 588" fill="#fff4f4">
          ...
          />
          <Path data-name="Path 323" d="M222.234 258.738h-5.59a.5.5 0 0 0 0 1h5.589a.5.5 0 0 0 0-1z" />
          <Path
            data-name="Path 324"
...
const SvgCloseButton = props => (
  <Svg width={28} height={28} {...props}>
    <G data-name="close button" transform="translate(-33 -320)">
      <Circle data-name="Ellipse 103" cx={14} cy={14} r={14} transform="translate(33 320)" fill="#2f8c83" />
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        ...
        <CameraIcon />
        {!renderUnity ? (
          <Button label="Turn on AR" style={styles.button} onPress={this.onToggleUnity.bind(this)} />
        ) : null}
        ...
        {renderUnity ? <Text style={{ color: '#fff', margin: 20, fontWeight: 'bold' }}>Point A Camera</Text> : null}
        <Modal
          animationType="slide"
