...
export default class NewsDetailScreen extends React.Component {
  ...
  // axiosInstance(apiUrls.getNewsDetails(id) + '?langCode=' + i18n.locale.toUpperCase()).then(
  // ({ data }) => {
  // this.setState({
  // dataSource: { newsItem: data, isLoading: false },
  // });
  // }
  // );
  // };
  ...
  render() {
    ...
    // console.log('dataSource.newsItem.ExternalContent', dataSource.newsItem.ExternalContent);
    // console.log('*******************************************************************************');

    // console.log('htmlWithTweets.tweets', htmlWithTweets.tweets)
    // console.log('*******************************************************************************')
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <SectionTitle
                    text={dataSource.newsItem.Title}
                    messageToShare={externalLinks.getNewsUrl(dataSource.newsItem.Id)}
